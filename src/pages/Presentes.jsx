...
// Preços são médias de referência (R$), concentrados na faixa de 200 a 500.
// Todos os valores devem existir em CARD_LINKS (config), para o botão de cartão.
const CATEGORIES = [
  {
    title: 'Cozinha',
    gifts: [
      ...
      { slug: 'microondas', name: 'Micro-ondas', price: 450 },
      { slug: 'batedeira', name: 'Batedeira', price: 300 },
      { slug: 'panela-pressao', name: 'Panela de pressão', price: 300 },
      { slug: 'liquidificador', name: 'Liquidificador', price: 250 },
      { slug: 'jogo-cha', name: 'Jogo de chá', price: 250 },
      { slug: 'jogo-facas', name: 'Jogo de facas', price: 250 },
      { slug: 'fondue', name: 'Panela de fondue', price: 250 },
      { slug: 'filtro-agua', name: 'Filtro de água', price: 250 },
      { slug: 'talheres-tramontina', name: 'Jogo de talheres inox Tramontina', price: 220 },
      { slug: 'tacas', name: 'Jogo de taças', price: 200 },
      { slug: 'sanduicheira', name: 'Sanduicheira / grill', price: 200 },
      { slug: 'chaleira', name: 'Chaleira elétrica', price: 200 },
      { slug: 'potes-mantimentos', name: 'Kit de potes de mantimentos', price: 200 },
      { slug: 'assadeiras', name: 'Kit de assadeiras', price: 200 },
      { slug: 'moedor-cafe', name: 'Moedor de café', price: 200 },
      { slug: 'espremedor', name: 'Espremedor de frutas', price: 200 },
      { slug: 'tabua-frios', name: 'Tábua de frios', price: 200 },
      { slug: 'boleira', name: 'Boleira', price: 140 },
      { slug: 'xicaras-cafe', name: 'Jogo de xícaras de café', price: 140 },
      { slug: 'escorredor-louca', name: 'Escorredor de louça', price: 140 },
      { slug: 'utensilios-cozinha', name: 'Kit de utensílios de cozinha', price: 140 },
      { slug: 'jogo-copos', name: 'Jogo de copos', price: 120 },
      { slug: 'porta-temperos', name: 'Porta-temperos', price: 120 },
      { slug: 'jarra-vidro', name: 'Jarra de vidro', price: 120 },
      { slug: 'fruteira', name: 'Fruteira', price: 120 },
      { slug: 'canecas', name: 'Jogo de canecas', price: 120 },
      { slug: 'toalha-mesa', name: 'Toalha de mesa', price: 120 },
      { slug: 'cesto-paes', name: 'Cesto de pães', price: 100 },
      { slug: 'jogo-americano', name: 'Jogo americano', price: 90 },
      { slug: 'formas-silicone', name: 'Kit de formas de silicone', price: 90 },
  ...
  },
  {
    ...
    gifts: [
      ...
      { slug: 'tapete-sala', name: 'Tapete de sala', price: 350 },
      { slug: 'cortina', name: 'Cortina', price: 300 },
      { slug: 'luminaria-piso', name: 'Luminária de piso', price: 300 },
      { slug: 'ventilador', name: 'Ventilador', price: 250 },
      { slug: 'quadro-decorativo', name: 'Quadro decorativo', price: 200 },
      { slug: 'almofadas', name: 'Kit de almofadas', price: 200 },
      { slug: 'mantas', name: 'Mantas para sofá', price: 200 },
      { slug: 'vaso-decorativo', name: 'Vaso decorativo', price: 200 },
  ...
  },
  {
    title: 'Quarto',
    gifts: [
      { slug: 'cama-box', name: 'Cama box casal', price: 2000 },
      { slug: 'armario-guarda-roupa', name: 'Guarda-roupa', price: 1000 },
      { slug: 'criado-mudo', name: 'Criado-mudo', price: 350 },
      { slug: 'jogo-cama', name: 'Jogo de cama', price: 300 },
      { slug: 'edredom', name: 'Edredom', price: 300 },
      { slug: 'espelho', name: 'Espelho', price: 250 },
      { slug: 'cortina-quarto', name: 'Cortina blackout', price: 250 },
      { slug: 'cabideiro', name: 'Cabideiro / arara', price: 200 },
      { slug: 'abajur', name: 'Abajur', price: 200 },
      { slug: 'protetor-colchao', name: 'Protetor de colchão', price: 200 },
      { slug: 'travesseiros', name: 'Travesseiros', price: 200 },
  ...
  },
  {
    ...
    gifts: [
      ...
      { slug: 'toalhas', name: 'Kit de toalhas', price: 220 },
      { slug: 'cesto-roupa', name: 'Cesto de roupa suja', price: 200 },
      { slug: 'kit-banheiro-acessorios', name: 'Kit de acessórios para banheiro', price: 200 },
      { slug: 'tapetes', name: 'Kit de tapetes', price: 140 },
      { slug: 'organizadores-gaveta', name: 'Organizadores de gaveta', price: 120 },
      { slug: 'lixeira-banheiro', name: 'Lixeira para banheiro', price: 100 },
  ...
  },
  {
    ...
    gifts: [
      ...
      { slug: 'tabua-passar', name: 'Tábua de passar', price: 250 },
      { slug: 'ferro-passar', name: 'Ferro de passar', price: 220 },
      { slug: 'balde-esfregao', name: 'Balde com esfregão (mop)', price: 200 },
      { slug: 'varal', name: 'Varal', price: 200 },
      { slug: 'cesto-organizador', name: 'Cesto organizador', price: 140 },
